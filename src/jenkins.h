...
#define JENKINS_STATE_UNKNOWN_STR   "unknown"
#define JENKINS_STATE_OFF_STR       "off"
#define JENKINS_STATE_RUNNING_STR   "running"
#define JENKINS_STATE_IDLE_STR      "idle"
...
#define JENKINS_RESULT_UNKNOWN_STR  "unknown"
#define JENKINS_RESULT_UNSTABLE_STR "unstable"
#define JENKINS_RESULT_SUCCESS_STR  "success"
#define JENKINS_RESULT_FAILURE_STR  "failure"
...
{
    uint16_t         chIx;                         //!< channel (< #CONFIG_NUM_CH)
...
/*!
    ...
    \param[in] update  true = update LEDs and recalculate overall state,
                       false = don't update, s.a. jenkinsUpdate()
*/
void jenkinsSetInfo(const JENKINS_INFO_t *pkInfo, bool update = true);
